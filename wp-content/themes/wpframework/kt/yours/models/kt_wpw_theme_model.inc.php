...
class KT_WPW_Theme_Model extends KT_WP_Options_Base_Model
{
    ...
    {
        parent::__construct(KT_WPW_Theme_Config::FORM_PREFIX);
    }
    ...
    {
        return $this->getOption(KT_WPW_Theme_Config::CATEGORY_NEWS_ID);
    }
    ...
    {
        return $this->getOption(KT_WPW_Theme_Config::COMPETITIVE_ADVATAGES_TITLE);
    }

    public function getCompetitiveAdvantagesMaxCount()
    {
        return $this->getOption(KT_WPW_Theme_Config::COMPETITIVE_ADVATAGES_MAX_COUNT);
    }

    public function getAddressTitle()
    {
        return $this->getOption(KT_WPW_Theme_Config::ADDRESS_TITLE);
    }

    public function getAddressStreet()
    {
        return $this->getOption(KT_WPW_Theme_Config::ADDRESS_STREET);
    }

    public function getAddressCity()
    {
        return $this->getOption(KT_WPW_Theme_Config::ADDRESS_CITY);
    }

    public function getAddressZip()
    {
        return $this->getOption(KT_WPW_Theme_Config::ADDRESS_ZIP);
    }

    public function getContactPhone()
    {
        return $this->getOption(KT_WPW_Theme_Config::CONTACT_PHONE);
    }

    public function getContactMobile()
    {
        return $this->getOption(KT_WPW_Theme_Config::CONTACT_MOBILE);
    }

    public function getContactEmail()
    {
        return $this->getOption(KT_WPW_Theme_Config::CONTACT_EMAIL);
    }

    public function getSocialFacebook()
    {
        return $this->getOption(KT_WPW_Theme_Config::SOCIAL_FACEBOOK);
    }

    public function getSocialTwitter()
    {
        return $this->getOption(KT_WPW_Theme_Config::SOCIAL_TWITTER);
    }

    public function getSocialGooglePlus()
    {
        return $this->getOption(KT_WPW_Theme_Config::SOCIAL_GOOGLE_PLUS);
    }

    public function getSocialYouTube()
    {
        return $this->getOption(KT_WPW_Theme_Config::SOCIAL_YOUTUBE);
    }

    public function getAnalyticsTrackingCode()
    {
        return $this->getOption(KT_WPW_Theme_Config::ANALYTICS_TRACKING_CODE);
    }

    public function getAnalyticsPixelCode()
    {
        return $this->getOption(KT_WPW_Theme_Config::ANALYTICS_PIXEL_CODE);
    }
    ...
    {
        $this->theSocialListItem($this->getSocialFacebook(), __("Facebook", "WPW_DOMAIN"), "facebook");
    }

    public function theSocialTwitter()
    {
        $this->theSocialListItem($this->getSocialTwitter(), __("Twitter", "WPW_DOMAIN"), "twitter");
    }

    public function theSocialGooglePlus()
    {
        $this->theSocialListItem($this->getSocialGooglePlus(), __("Google+", "WPW_DOMAIN"), "google");
    }

    public function theSocialYouTube()
    {
        $this->theSocialListItem($this->getSocialYouTube(), __("YouTube kanál", "WPW_DOMAIN"), "youtube");
    }
