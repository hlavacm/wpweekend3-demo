...
class KT_WPW_Reference_Model extends KT_WP_Post_Base_Model
{
    function __construct(WP_Post $post)
    {
        parent::__construct($post, KT_WPW_Reference_Config::FORM_PREFIX);
    }
    ...
    {
        return $this->getMetaValue(KT_WPW_Reference_Config::PARAMS_TYPES);
    }

    public function getParamDateCreation()
    {
        return $this->getMetaValue(KT_WPW_Reference_Config::PARAMS_DATE);
    }

    public function getParamClientName()
    {
        return $this->getMetaValue(KT_WPW_Reference_Config::PARAMS_CLIENT);
    }
