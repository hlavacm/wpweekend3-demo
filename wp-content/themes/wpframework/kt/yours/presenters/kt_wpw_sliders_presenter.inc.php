...
class KT_WPW_Sliders_Presenter extends KT_Presenter_Base
{
    ...
    public function theInners()
    {
        if ($this->hasPosts()) {
            ...
            foreach ($this->getPosts() as $post) {
                ...
                $imageSrc = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), KT_WPW_IMAGE_SIZE_SLIDER);
