...
class KT_WPW_Sidebar_Presenter extends KT_Presenter_Base
{
    ...
    public function render()
    {
        ...
        if (is_page()) {
            if ($this->isPages()) {
                $currentId = $post->ID;
                echo "\n<div class=\"widget\">";
                echo "<h2 class=\"widgettitle\">" . __("Stránky", "WPW_DOMAIN") . "</h2>";
            ...
            echo "\n<div class=\"widget\">";
            echo "<h2 class=\"widgettitle\">" . __("Kategorie", "WPW_DOMAIN") . "</h2>";
            echo "<ul class=\"nav nav-pills nav-stacked\">";
    ...
    /** @return KT_WPW_Sidebar_Presenter */
    private function initCurrentSidebar()
    {
        global $wp_registered_sidebars;
        $sidebarKey = KT_WPW_SIDEBAR_DEFAULT;
