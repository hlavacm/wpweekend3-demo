...
class KT_WPW_References_Presenter extends KT_Presenter_Base
{
    ...
    public function thePosts()
    {
        if ($this->hasPosts()) {
            ...
            self::theItemsLoops($this->getPosts(), KT_WPW_REFERENCE_KEY, null, null, $clearfixes);
        }
    }
    ...
    {
        $args = [
            "post_type" => KT_WPW_REFERENCE_KEY,
            "post_status" => "publish",
